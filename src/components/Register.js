          ...
          <div className="card shadow">
            <div className="card-body">
              <div className="card-logo-container">
                <img
                  src={logo_bouygue}
                  alt="Logo bouygue Telecom"
                  className="card-logo"
                />
              </div>
              <div className="text-center fs-3 fw-bold register-txt">
                S'inscrire
              </div>
              ...
              <form className="mt-3" onSubmit={handleRegisterSubmit}>
                ...
                <div className="form-group mt-2">
                  <label htmlFor="motdepasse" className="mb-2">
                    Mot de passe
                  </label>
                  <input
                    type="password"
                ...
                <div className="register-btn-container mt-3">
                  <button type="submit" className="btn register-btn mt-2">
                    S'inscrire
                  </button>
                </div>
                <div className="btn-login-container fw-bold">
                  <a href="/" className="btn login-btn mt-2">
                    Se connecter
                  </a>
                </div>
              </form>
